  ...
  var uiLoop = window.setInterval(function() {
    ...
    if (gameData.progression < 1) {
      ...
      document.getElementById("tempResetButton").style.display = "block"
    ...
    if (gameData.progression < 2) {
      ...
      document.getElementById("buyAlphaButton").style.display = "block"
    ...
    if (gameData.progression < 3) {
      ...
      document.getElementById("buyBetaButton").style.display = "block"
