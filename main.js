  ...
  var uiLoop = window.setInterval(function() {
    ...
    document.getElementById("eatMeatButton").innerHTML = "Eat 1 piece of Meat to gain " + format(500 * (2.5 * Math.sqrt(gameData.taste)), "scientific") + " time and improve your taste by +0.5 for 0.1 α"
    if (gameData.temporalResets < 8) {
