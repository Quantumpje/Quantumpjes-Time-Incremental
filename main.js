  ...
  function gainTime() {
    gameData.time += (gameData.timemodLevel * (1 + gameData.temporalResets / 5)) / 20
  }
  ...
  var mainGameLoop = window.setInterval(function() {
    gainTime()
    document.getElementById("timeGained").innerHTML = format(gameData.time, "scientific") + " Time gained, current speed: " + format(gameData.timemodLevel * (1 + gameData.temporalResets / 5), "scientific") + "/s" 
  ...
  var uiLoop = window.setInterval(function() {
    ...
    document.getElementById("tempResetButton").innerHTML = "Initiate Temporal Reset, Cost: " + format((150 * 1.25 ** gameData.temporalResets), "scientific") + " Time and resets Time and Time Modulator"
    if (gameData.temporalResets < 8) {
    ...
    if (gameData.progression < 1) {
      ...
      document.getElementById("tempResetsGained").style.display = "initial"
    }
    if (gameData.progression < 2) {
      ...
      document.getElementById("alphaGained").style.display = "initial"
    }
    if (gameData.progression < 3) {
      ...
      document.getElementById("betaGained").style.display = "initial"
    }
  }, 200)
